...
class dwm1001_localizer:
    ...
    def publishTagPositions(self, serialData):
        ...
        # If plugged into the tag:
        if b"DIST" in ser_pose_data[0] :
            ...
            tag_id = str(ser_pose_data[-5], 'UTF8')
            ps = PoseStamped()
            ...
            ps.header.frame_id = "1AA1" # TODO: Currently, MAC ID of the Tag is set as a frame ID 
        ...
        # If plugged into passive listener tag:
        elif b"POS" in ser_pose_data[0] :
            #rospy.loginfo(ser_pose_data)  # just for debug
